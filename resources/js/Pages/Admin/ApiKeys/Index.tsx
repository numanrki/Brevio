...
export default function Index() {
    const { apiKeys, availableScopes, flash } = usePage<{ apiKeys: ApiKeyItem[]; availableScopes: Record<string, string>; flash?: { success?: string; error?: string; new_key?: string }; auth: any; app_version?: string }>().props;
                                                ...
                                                {revealedKeys[key.id] && (
                                                    <div className="flex items-center gap-2 mt-3">
                                                        ...
                                                        <button
                                                            ...
                                                            className="p-2 text-gray-400 hover:text-emerald-400 hover:bg-emerald-500/10 rounded-lg transition-all flex-shrink-0"
                                                            title="Copy API key"
                                                        >
                                                            {copied ? (
