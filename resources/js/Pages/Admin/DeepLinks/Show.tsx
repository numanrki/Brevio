                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        <div>
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <button onClick={copyLink} className={`shrink-0 p-1 rounded transition-colors ${copied ? 'text-emerald-400' : 'text-gray-500 hover:text-white'}`} title={copied ? 'Copied!' : 'Copy'}>
                                    {copied ? (
