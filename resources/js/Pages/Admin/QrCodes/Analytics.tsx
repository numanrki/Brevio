...
export default function Analytics({ qrCode, range, ranges, summary, visits_over_time, top_countries, top_cities, top_browsers, top_os, devices, top_referrers, visitor_log }: Props) {
