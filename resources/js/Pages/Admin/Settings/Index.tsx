...
export default function Index({ settings, has2fa, callbackUrl }: Props) {
                ...
                {sections.map((section) => (
                    <div key={section.title} className="rounded-xl bg-gray-900 border border-gray-800 overflow-hidden">
                        ...
                        <div className="p-6 space-y-5">
                            ...
                            {/* Google Auth section extras: Callback URL + Enable checkbox */}
                                ...
                                <>
                                    <div>
                                        ...
                                        <div className="flex items-center gap-2">
                                            <input
                                                ...
                                                value={callbackUrl}
                                                readOnly
                                                className="flex-1 px-4 py-2.5 bg-gray-950 border border-gray-800 rounded-xl text-sm text-gray-400 font-mono cursor-default focus:outline-none"
                                            />
                                            <button
                                                type="button"
                                                onClick={copyCallback}
                                                className="flex-shrink-0 p-2.5 bg-gray-800 hover:bg-gray-700 border border-gray-700 rounded-xl transition-colors"
                                        ...
                                        <p className="mt-1.5 text-xs text-gray-500">Copy this URL and paste it as the Authorized redirect URI in your Google Cloud Console.</p>
                                    </div>
                                    ...
                                    <label className="flex items-start gap-3 cursor-pointer">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 mt-0.5">Allow admins to sign in with Google. Requires valid Client ID and Secret.</p>
                                        </div>
                                    </label>
                                </>
                            )}
