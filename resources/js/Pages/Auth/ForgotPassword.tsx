...
export default function ForgotPassword({ status }: { status?: string }) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(url('/admin/forgot-password'));
    };
            ...
            <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
                ...
                <div className="relative w-full max-w-sm">
                    ...
                    <div className="rounded-2xl bg-gray-900 border border-gray-800 p-8">
                        <h2 className="text-lg font-semibold text-white text-center mb-1">Forgot password?</h2>
                        ...
                        <div className="mt-5 text-center">
                            <a href={url('/admin/login')} className="text-sm text-violet-400 hover:text-violet-300 transition-colors">
                                Back to login
                            </a>
                        </div>
                    </div>
