...
export default function Stats({
    range, ranges, summary, clicks_over_time,
    top_countries, top_referrers, top_browsers,
    top_os, devices, top_languages,
}: Props) {
    const changeRange = (newRange: string) => {
        router.get(url('/dashboard/stats'), { range: newRange }, { preserveState: true, preserveScroll: true });
    };
                    ...
                    {clicks_over_time.length === 0 ? (
                        ...
                        <ResponsiveContainer width="100%" height={280}>
                            <AreaChart data={clicks_over_time} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
                                <defs>
                                    <linearGradient id="statsClickGradient" x1="0" y1="0" x2="0" y2="1">
                ...
                <div className="rounded-xl bg-gray-900 border border-gray-800 overflow-hidden">
                    ...
                    <div className="p-6">
                        {top_languages.length === 0 ? (
                            ...
                            <ProgressList items={top_languages} gradient="from-amber-500 to-orange-500" />
                        )}
                    </div>
                </div>
            </div>
                ...
                <div className="rounded-xl bg-gray-900 border border-gray-800 overflow-hidden">
                    ...
                    <div className="p-6">
                        {top_countries.length === 0 ? (
                            ...
                            <ProgressList items={top_countries} gradient="from-violet-500 to-fuchsia-500" />
                        )}
                    </div>
                </div>
                ...
                <div className="rounded-xl bg-gray-900 border border-gray-800 overflow-hidden">
                    ...
                    <div className="p-6">
                        {top_browsers.length === 0 ? (
                            ...
                            <ProgressList items={top_browsers} gradient="from-cyan-500 to-blue-500" />
                        )}
                    </div>
                </div>
            </div>
                ...
                <div className="rounded-xl bg-gray-900 border border-gray-800 overflow-hidden">
                    ...
                    <div className="p-6">
                        {top_os.length === 0 ? (
                            ...
                            <ProgressList items={top_os} gradient="from-emerald-500 to-green-500" />
                        )}
                    </div>
                </div>
